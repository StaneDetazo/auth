...
<head>
    ...
    <!-- Empecher le retour a la page précédente après deconnexion -->
    <!-- <script>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="firstname" type="text"
                                        ...
                                        value="" required autocomplete="firstname">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="age" type="number"
                                        ...
                                        value="" required autocomplete="age">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="birthday" type="date"
                                        ...
                                        value="" required autocomplete="birthday">
                                </div>
                            </div>
